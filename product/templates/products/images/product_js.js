...
function toggle_product_popup(e) {

    id = e.parentsUntil("li").parent().attr("id");
...
function product_html_for_staff() {
    return ('<button class="btn  btn-primary edit_class" style=" margin-top:-5%;width:16%; ">Edit</button> \
...
function product_html_li(data) {
    ...
    <li class="media " id="' + data.id + '"> \
        <div class="media-left "> \
          <a href="#"> \
            <img class="media-object" style="width: 100px; height: 30%; "  src=' + data.image + ' alt="Product image"> \
          </a> \
        </div> \
        <div class="media-body "> \
            ...
            <button class="btn  btn-primary buy_class" style="margin-left:10%; margin-top:-5%;width:16%; ">Buy</button> \
         ');
}
